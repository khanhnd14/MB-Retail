...
export default class AppIntroSlider extends React.Component {
    ...
    let content = (
      <Text
        style={[
          ...
          (name === 'Skip' || name === 'Prev' || name === 'Signup') && {
            color: '#fff',
          },
        ]}
      >
  ...
  _renderOuterButton = (content, name, onPress) => {
    ...
    return (
      <View style={!this.props.bottomButton && style}>
        <TouchableOpacity onPress={onPress} style={this.props.buttonStyle}>
          {content}
        </TouchableOpacity>
      </View>
    )
  ...
  _renderSignupButton = () =>
    this._renderButton('Signup', this.props.onSignup && this.props.onSignup)
  ...
  _renderPagination = () => {
    ...
    // const signupBtn = this._renderSignupButton()
...
AppIntroSlider.defaultProps = {
  ...
  nextLabel: 'Next',
  prevLabel: 'Back',
  signupLabel: 'Create new account',
  buttonStyle: null,
