...
import { ModalSelect, Icon, Text } from '../../../components';
...
const SelectAccount = ({ data, onSelectRolloutAccountNo, changeFromAccount, setRef, notPreSelect }) => {
  const [isVisible, setVisible] = React.useState(false)
  const [currentAcc, setCurrentAcc] = React.useState(notPreSelect ? null : 0)
  ...
  return (
    <View style={styles.container} onTouchStart={() => setVisible(true)}>
      <ModalSelect title={I18n.t('transfer.holder_account')} visible={isVisible} handleModal={() => setVisible(false)}>
